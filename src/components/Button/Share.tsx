...
import { useScreenshotValue } from "../../recoil/screenshot";
...
const ShareButton = (props) => {
  const screenshot = useScreenshotValue();
  ...
  const onPress = async () => {
    ...
    if (props._onPress) props._onPress();
  };

  if (!screenshot) {
    return null;
  }
  return <Icon onPress={onPress} name="share" {...props} />;
};
